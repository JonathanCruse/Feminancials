...
export class CollectiveDto implements ICollectiveDto {
    id?: number;
    name?: string;
    collectivesFeminists?: FeministsCollectivesDto[];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["collectivesFeminists"])) {
                ...
                for (let item of _data["collectivesFeminists"])
                    this.collectivesFeminists!.push(FeministsCollectivesDto.fromJS(item));
            }
...
export class FeministsCollectivesDto implements IFeministsCollectivesDto {
    balance?: number;
    feminist?: FeministDto;
    collective?: CollectiveDto;

    constructor(data?: IFeministsCollectivesDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): FeministsCollectivesDto {
        data = typeof data === 'object' ? data : {};
        let result = new FeministsCollectivesDto();
        result.init(data);
        return result;
    }
...
export interface IFeministsCollectivesDto {
    balance?: number;
    feminist?: FeministDto;
    collective?: CollectiveDto;
}
...
export class FeministDto implements IFeministDto {
    id?: string;
    userName?: string;
    feministsCollectives?: FeministsCollectivesDto[];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["feministsCollectives"])) {
                ...
                for (let item of _data["feministsCollectives"])
                    this.feministsCollectives!.push(FeministsCollectivesDto.fromJS(item));
            }
        }
    }
...
export class TransactionDto implements ITransactionDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.cretitor = _data["cretitor"] ? FeministDto.fromJS(_data["cretitor"]) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["cretitor"] = this.cretitor ? this.cretitor.toJSON() : <any>undefined;
...
export class ExpenseDto implements IExpenseDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.creditor = _data["creditor"] ? CollectiveDto.fromJS(_data["creditor"]) : <any>undefined;
        }
    }
